...
from models.img_style_generator.models.networks.normalization import get_nonspade_norm_layer
...
class FPSEDiscriminator(BaseNetwork):
    ...
    def forward(self, fake_and_real_img, segmap=None, sem_alignment_only=False):
        ...
        if segmap is not None and self.conditional:
            ...
            pred2 = pred2 + sem_pred2 if pred2 else sem_pred2
            pred3 = pred3 + sem_pred3 if pred3 else sem_pred3
            pred4 = pred4 + sem_pred4 if pred4 else sem_pred4
