...
class OhemCrossEntropy2d(nn.Module):
    ...
    def __init__(self, ignore_label=255, thresh=0.7, min_kept=100000, factor=8, reduction='mean'):
        ...
        self.factor = factor
        self.criterion = torch.nn.CrossEntropyLoss(ignore_index=ignore_label, reduction=reduction)
